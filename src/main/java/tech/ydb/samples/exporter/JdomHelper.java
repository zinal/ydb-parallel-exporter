...
class JdomHelper {
    ...
    public static Element readDocument(File file) {
        try (FileInputStream fis = new FileInputStream(file)) {
            ...
            throw new RuntimeException("Failed to read document " + file, ex);
        }
    }

    public static Element readDocument(String fileName) {
     ...
     * @return The list with at least one sub-element, exception is thrown otherwise
     */
